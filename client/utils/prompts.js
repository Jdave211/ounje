...
export const RECIPE_PROMPT = `Create multiple recipes for meals using the food items that the user provides using this format in a single array of json object.
