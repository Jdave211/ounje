...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.recipe_ingestion_jobs TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.recipe_ingestion_artifacts TO service_role;
