...
export const SOCIAL_VIDEO_RECIPE_MODEL = process.env.SOCIAL_VIDEO_RECIPE_MODEL ?? "gpt-4.1-mini";
...
export const RECIPE_IMPORT_HARD_COMPLETION_MODEL = process.env.RECIPE_IMPORT_HARD_COMPLETION_MODEL ?? "gpt-4.1-mini";
...
export const RECIPE_COMPLETION_SONAR_MODEL = process.env.RECIPE_COMPLETION_SONAR_MODEL ?? "sonar-pro";
